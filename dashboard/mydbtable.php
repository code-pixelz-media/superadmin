<?php 
define('DB_PREFIX', 'dz20_yns_'); // Define your table prefix


class Dzyns_Database {
    private $dzyns_host = 'localhost';
    private $dzyns_db_name = 'sql_dzyns_codepi';
    private $dzyns_username = 'sql_dzyns_codepi';
    private $dzyns_password = '3616db0363b2e';
    public $dzyns_conn;
