...
class JwtHelper {
    ...
    public function generateTokenPair($payload) {
        try {
            ...
            return [
                ...
                'access_token_expires_in' => JWT_ACCESS_TOKEN_EXPIRY,
                'refresh_token_expires_in' => JWT_REFRESH_TOKEN_EXPIRY,
            ];
        } catch (Exception $e) {
    ...
    public function validate($token, $isRefreshToken = false) {
        ...
        try {
            ...
            return $this->handleError(402, 'Invalid token', ['error' => $e->getMessage()]);
        }
    }
